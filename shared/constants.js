...
export const WEAPONS = {
  ...
  Railgun: {
    ...
    fireRate: 200,      // 5/sec
    maxAmmo: 100,
    reloadTime: 0,      // can't reload normally
    spread: 0.005,
    range: 500,
    auto: true,
    price: 0,
...
export const SHOP_ITEMS = [
  { id: 'Minigun', name: '미니건', price: 300, desc: '고속 연사 (10발/초)', category: 'weapon', slot: 0 },
  { id: 'Shotgun', name: '샷건', price: 250, desc: '근거리 산탄 (5발)', category: 'weapon', slot: 0 },
  ...
  { id: 'Axe', name: '도끼', price: 400, desc: '강력한 근접 (80 데미지)', category: 'weapon', slot: 2 },
  { id: 'HealthPack', name: '회복팩', price: 30, desc: 'HP 50 회복', category: 'consumable' },
];
...
export const NPC_TYPES = {
  ...
  boss:   { health: 2000, speed: 10.5, scale: 2.5,  bodyColor: 0x4a0080, coinDrop: 300, dmg: 100, name: 'BOSS',    xp: 10 },
};
